<div class="modal fade bd-example-modal-lg" id="addAthleteModal" tabindex="-1" role="dialog" aria-labelledby="addAthleteModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="displayoptions" style="margin: auto; border: 0pt solid black;">
							...
							<tr>
								<td colspan="2">
									<div class="autocomplete" style="width:50%;">
										<input id="myInput" class="form-control" type="text" name="athletes" placeholder="Search for Athletes...">
									</div>
								</td>
							</tr>
							<tr>
