...
<html lang="en">
	<head>
		...
		<style>
			...
			.arrow:before {
				border-top-color: rgb(44, 9, 173);
				border-bottom-color: rgb(44, 9, 173);
				border-right-color: rgb(44, 9, 173);
			}
			...
			.arrow:after {
				border-left-color: rgb(44, 9, 173);
			}
	...
	<body>
		<main>
			...
			<div>
				<div style="border: thin solid black; text-align: center; padding: 20px;">
			...
			<div id="notices">
				...
				<div class="notice"><b>Bank:</b> FNB; <b>Account Type:</b> Cheque; <b>Account Number:</b> 623 5525 0102; <b>Branch Code:</b> 250 655</div>
			</div>
		</main>
		<footer>
