$(document).ready(function() {
    ...
    // $("#add_name").bind('paste', function(e) {
    //     alert('pasting text!');
    // });
...
//     var tr;
//     $('#clientTableData').html('');
//     for (var i = 0; i < displayRecords.length; i++) {
//         tr = $('<tr/>');
//         tr.append("<td>" + displayRecords[i].companyname + "</td>");
//         tr.append("<td>" + displayRecords[i].name + ' ' + displayRecords[i].surname + "</td>");
//         tr.append("<td>" + displayRecords[i].mobile + "</td>");
//         tr.append("<td>" + displayRecords[i].email + "</td>");
//         tr.append("<td>" + editAndSaveButtons() + "</td>");
//         $('#clientTableData').append(tr);
//     }
// }
